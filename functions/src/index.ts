...
// Pega a chave do ambiente ou usa string vazia (para evitar erro de tipo,
// mas falhará se vazio)
...
export const callGeminiAgent = onCall(
  ...
  async (request: CallableRequest<AgentRequestData>) => {
    ...
    // O TypeScript agora sabe que 'content', 'systemInstruction' etc
    // existem por causa da interface acima
